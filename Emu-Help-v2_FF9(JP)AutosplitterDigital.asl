...
startup 
{
	...
	{
        emu.Make<short>("ScenarioCounter", 0x8007A3C0);
        emu.Make<short>("fieldId", 0x8008FA5C);
        emu.Make<short>("fieldEntrance", 0x8007A3C2);
        emu.Make<short>("battleId", 0x8008FA5E);
        emu.Make<short>("stateFlag", 0x8008F808);
        emu.Make<short>("currentHPchar1", 0x8009CE68);
        emu.Make<short>("currentHPenemy1", 0x80108A64);
        emu.Make<short>("pauseFlag", 0x8008FA50);
        emu.Make<byte>("NGscreen", 0x8007E2C0);
		return true;
	});
