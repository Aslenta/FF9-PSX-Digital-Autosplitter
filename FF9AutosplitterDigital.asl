...
update 
{
    ...
    vars.ScenarioCounterAddress = vars.baseRAMAddress + 0x7AEF0;
    vars.fieldIdAddress = vars.baseRAMAddress + 0x8B25C;
    vars.fieldEntranceAddress = vars.baseRAMAddress + 0x7AEF2;
    vars.battleIdAddress = vars.baseRAMAddress + 0x8B25E;
    vars.stateFlagAddress = vars.baseRAMAddress + 0xBD990;
    vars.currentHPchar1Address = vars.baseRAMAddress + 0x98668;
    vars.currentHPenemy1Address = vars.baseRAMAddress + 0x109264;
    vars.pauseFlagAddress = vars.baseRAMAddress + 0x8B250;
    vars.NGscreenAddress = vars.baseRAMAddress + 0x7EE00;
...
split
{
    if(settings["1"])
    {
        ...
        {
            if(settings["1.1"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 336 && !vars.Splits.Contains("magemasher"))
            {
                vars.Splits.Add("magemasher");
                return true;
            }
            if(settings["1.2"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 338 && !vars.Splits.Contains("kingleo"))
            {
        ...
        {
            if(settings["1.3"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 337 && !vars.Splits.Contains("steiner1"))
            {
                vars.Splits.Add("steiner1");
                return true;
            }
            if(settings["1.4"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 335 && !vars.Splits.Contains("steiner2"))
            {
                vars.Splits.Add("steiner2");
                return true;
            }
            if(settings["1.5"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 334 && !vars.Splits.Contains("steiner3"))
            {
        ...
        {
            if(settings["1.6"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 301 && !vars.Splits.Contains("prisoncage"))
            {
                vars.Splits.Add("prisoncage");
                return true;
            }
            if(settings["1.7"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 295 && !vars.Splits.Contains("baku"))
            {
                vars.Splits.Add("baku");
                return true;
            }
            if(settings["1.8"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 303 && !vars.Splits.Contains("plantbrain"))
            {
        ...
        {
            if(settings["1.10"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 21 && !vars.Splits.Contains("sealion"))
            {
        ...
        {
            if(settings["1.11"] && old.stateFlag == 7000 && current.stateFlag == 10273 && current.fieldId == 359 && !vars.Splits.Contains("dali"))
            {
                vars.Splits.Add("dali");
                return true;
            }
            if(settings["1.12"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 294 && !vars.Splits.Contains("blackwaltz2"))
            {
                vars.Splits.Add("blackwaltz2");
                return true;
            }
            if(settings["1.13"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 296 && !vars.Splits.Contains("blackwaltz3"))
            {
        ...
        {
            if(settings["1.14"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 13 && current.currentHPchar1 == 0 && !vars.Splits.Contains("mu"))
            {
                vars.Splits.Add("mu");
                return true;
            }
            if(settings["1.15"] && old.stateFlag == 7000 && current.stateFlag == 10273 && current.fieldId == 701 && current.ScenarioCounter == 3700 && !vars.Splits.Contains("entergizamaluke"))
            {
                vars.Splits.Add("entergizamaluke");
                return true;
            }
            if(settings["1.16"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 326 && !vars.Splits.Contains("gizamaluke"))
            {
        ...
        {
            if(settings["1.17"] && old.stateFlag == 7000 && current.stateFlag == 10273 && current.fieldId == 750 && current.ScenarioCounter == 3760 && !vars.Splits.Contains("burmecia"))
            {
                vars.Splits.Add("burmecia");
                return true;
            }
            if(settings["1.18"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 4 && !vars.Splits.Contains("beatrix1"))
            {
    ...
    if(settings["2"])
    {
        ...
        {
            if(settings["2.1"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 52 && !vars.Splits.Contains("blackwaltz32"))
            {
                vars.Splits.Add("blackwaltz32");
                return true;
            }
            if(settings["2.2"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 76 && !vars.Splits.Contains("ralvurahva"))
            {
        ...
        else if(current.ScenarioCounter >= 4650 && current.ScenarioCounter < 5030)
        {
            ...
            if(settings["2.4"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 300 && !vars.Splits.Contains("antlion"))
            {
                vars.Splits.Add("antlion");
                return true;
            }
            if(settings["2.5"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 299 && !vars.Splits.Contains("beatrix2"))
            {
        ...
        else if(current.ScenarioCounter >= 5030 && current.ScenarioCounter < 5400)
        {
            ...
            if(settings["2.7"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 930  && !vars.Splits.Contains("tantarian"))
            {
                vars.Splits.Add("tantarian");
                return true;
            }
            if(settings["2.8"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 74 && !vars.Splits.Contains("zornandthorn"))
            {
                vars.Splits.Add("zornandthorn");
                return true;
            }
            if(settings["2.9"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 73 && !vars.Splits.Contains("beatrix3"))
            {
                vars.Splits.Add("beatrix3");
                return true;
            }
            if(settings["2.10"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 75 && !vars.Splits.Contains("ralvuimago"))
            {
        ...
        {
            if(settings["2.11"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 83 && !vars.Splits.Contains("lani"))
            {
                vars.Splits.Add("lani");
                return true;
            }
            if(settings["2.12"] && old.stateFlag == 10273 && current.stateFlag == 7000 && current.fieldId == 1425 && current.ScenarioCounter == 5990 && !vars.Splits.Contains("fossilroo"))
            {
        ...
        {
            if(settings["2.13"] && old.stateFlag == 10273 && current.stateFlag == 7000 && current.fieldId == 1450 && current.ScenarioCounter == 6212 && !vars.Splits.Contains("blackmagevillage"))
            {
        ...
        {
            if(settings["2.14"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 107 && !vars.Splits.Contains("hilgigars"))
            {
                vars.Splits.Add("hilgigars");
                return true;
            }
            if(settings["2.15"] && old.stateFlag == 7000 && current.stateFlag == 10273 && current.fieldId == 1650 && current.ScenarioCounter == 6690 && !vars.Splits.Contains("enteriifatree"))
            {
                vars.Splits.Add("enteriifatree");
                return true;
            }
            if(settings["2.16"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 116 && !vars.Splits.Contains("soulcage"))
            {
        ...
        {
            if(settings["2.17"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 132 && !vars.Splits.Contains("amarant"))
            {
    ...
    if(settings["3"])
    {
        if(current.ScenarioCounter >= 7010 && current.ScenarioCounter < 9410)
        {
            ...
            if(settings["3.2"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 915 && current.ScenarioCounter == 8340 && !vars.Splits.Contains("mistodons"))
            {
    ...
    if(settings["4"])
    {
        ...
        {
            if(settings["4.1"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 931 && !vars.Splits.Contains("novadragon"))
            {
                vars.Splits.Add("novadragon");
                return true;
            }
            if(settings["4.2"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 932 && !vars.Splits.Contains("maliris"))
            {
                vars.Splits.Add("maliris");
                return true;
            }
            if(settings["4.3"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 933 && !vars.Splits.Contains("tiamat"))
            {
                vars.Splits.Add("tiamat");
                return true;
            }
            if(settings["4.4"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 934 && !vars.Splits.Contains("kraken"))
            {
                vars.Splits.Add("kraken");
                return true;
            }
            if(settings["4.5"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 935 && !vars.Splits.Contains("lich"))
            {
                vars.Splits.Add("lich");
                return true;
            }
            if(settings["4.6"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 936 && !vars.Splits.Contains("deathguise"))
            {
                vars.Splits.Add("deathguise");
                return true;
            }
            if(settings["4.7"] && old.stateFlag == 4139 && current.stateFlag == 10273 && current.battleId == 937 && !vars.Splits.Contains("trancekuja"))
            {
...
isLoading
{
    return ((current.ScenarioCounter == 7010 && current.fieldEntrance == 202 && current.fieldId == 1851) || current.pauseFlag == 32);
}
